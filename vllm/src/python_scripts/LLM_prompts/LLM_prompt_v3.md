...
2. in_group_vs_out_group_exclusion
- **Core Logic:** A horizontal cleavage pitting the "Native/In-group Population" against an "Immigrant/minority External Out-group".
...
3. institutional_knowledge_denial
...
6. systemic_sovereignty_revival
